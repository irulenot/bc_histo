...
def fft_transform(batch_data, device):
    ...
    image = torch.tensor(np.load(image_path)['arr_0']).real
...
def parse_args():
    ...
    parser.add_argument(
        "--data_root", default="/data/breast-cancer/PANDA/train_images_FFT2000_WSI/", help="path to root folder of images"
    )
...
if __name__ == "__main__":
    ...
    if args.dataset_json is None:
        ...
        if args.quick == True:
            dst = "datalists/train_images_FFT2000_WSI_quick.json"
        else:
            dst = "datalists/train_images_FFT2000_WSI.json"
