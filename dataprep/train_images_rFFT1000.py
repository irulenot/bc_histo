...
output_dir = '/data/breast-cancer/PANDA/train_images_rFFT1000_WSI_both_centered/'
...
def process_tiff(tiff_file):
    ...
    start_h1, start_w1 = h // 2 - crop_size // 2, w - crop_size
    start_h, start_w = h // 2 - crop_size // 2, w // 2 - crop_size // 2
    
    fft_img = fft_img[:, start_h:start_h+crop_size, start_w1:start_w1+crop_size]
