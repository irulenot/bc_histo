...
# Directory path
directory = '/data/breast-cancer/PANDA/train_images_FFT1000'
...
json_file = '/home/anthony/bc_histo/datalists/train_images_FFT1000.json'
...
data['training'] = data['training'][:800]
data['validation'] = data['validation'][:200]

# Path to save the JSON file
json_file = '/home/anthony/bc_histo/datalists/train_images_FFT1000_quick.json'
