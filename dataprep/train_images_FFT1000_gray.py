...
output_dir = '/data/breast-cancer/PANDA/train_images_FFT1000_WSI_both_centered_gray/'
...
def process_tiff(tiff_file):
    ...
    crop_size = 1000
    h, w = fft_img.shape[1], fft_img.shape[2]
    ...
    if fft_img.shape[1] != crop_size or fft_img.shape[2] != crop_size:
        return
