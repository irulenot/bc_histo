...
# Directory path
directory = '/data/breast-cancer/PANDA/train_images_FFT1000_WSI_both_centered_gray'
...
json_file = '/home/anthony/bc_histo/datalists/train_images_FFT1000_WSI_both_centered_gray.json'
...
data['training'] = data['training'][:200]
data['validation'] = data['validation'][:40]

# Path to save the JSON file
json_file = '/home/anthony/bc_histo/datalists/train_images_FFT1000_WSI_both_centered_gray_quick.json'
