...
output_dir = '/data/breast-cancer/PANDA/train_images_FFT2/'
...
def process_tiff(tiff_file):
    ...
    fft_tensor = np.pad(fft_tensor, ((0, 0), (0, 0), (24, 24), (24, 24)), mode='constant', constant_values=0)
    fft_tensor = np.squeeze(fft_tensor)

    if fft_tensor.shape[-1] != 2048 or fft_tensor.shape[-2] != 2048:
        return None
