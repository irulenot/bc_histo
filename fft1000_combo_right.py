...
def parse_args():
    ...
    parser.add_argument(
        "--data_root", default="/data/breast-cancer/PANDA/train_images_FFT1000_WSI_both_right/", help="path to root folder of images"
    )
...
if __name__ == "__main__":
    ...
    if args.dataset_json is None:
        ...
        if args.quick == True:
            dst = "datalists/train_images_FFT1000_WSI_both_right_quick.json"
        else:
            dst = "datalists/train_images_FFT1000_WSI_both_right.json"
