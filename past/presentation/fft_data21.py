...
for c in range(3):
    ...
    # Perform FFT
    fft_result = torch.fft.fftshift(torch.fft.fft2(channel, dim=(-2, -1)))
...
fig.suptitle('FFT Shifted', fontsize=16, fontweight='bold')

# Adjust spacing and layout
fig.tight_layout(pad=0.0)
plt.subplots_adjust(wspace=0.1, hspace=0.1)

plt.savefig('all_channels_combined2.png')
plt.close()
